...
public class WeaponOfTemplar {
    class Solution {
        public int solution(int number, int limit, int power) {
            ...
            // 제한을 안넘는 무기는 결과값에 그대로 더하고
            // 제한을 초과하는 무기는 지정된 값(power)만큼 결과값에 더한다
        ...
        // 약수의 개수를 구하는 메소드
        // 구하려는 숫자까지 전부 루프를 도는 것이 아니라 제곱근이하만 확인
        // 약수인 경우 약수와 약수로 나눈값이 같다면(ex. 9의 약수 3, 16의 약수 4)
        // 약수개수는 하나만 증가, 아니라면 제곱근 초과범위에서 대칭되는 약수값이 있으므로 둘 증가
